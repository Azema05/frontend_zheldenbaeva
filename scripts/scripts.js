...
//       <p class="card_text">${card.body}</p>
//       <div class="card_footer">
//         <img class="card_avatar" src="/img/avatar.png" alt="avatar">
//         <p class="card_person">
//           <span class="card_person-name">${card.name}</span>
//           <small class="card_person-type">User</small>
//         </p>
...
//   .then(response => response.json())
//   .then(data => {
//     console.log('Полученные данные:', data); // Можно посмотреть в консоли браузера
//     showAllCards(data); // Отображаем карточки
//   })
//   .catch(error => console.error('Ошибка при получении данных:', error));
